...
const testimonials = [
  {
    name: "Rana Asad",
    role: "Datics ai labs",
    avatar: "https://titoaistorageaccount.blob.core.windows.net/titoai-storage/e38de4ea-ece0-4ca7-98db-6f8e0424eee3/images/uploaded-1782743291954-ldu5hs.png?v=1782743292235",
    quote:
...
export default function HomePage() {
  ...
  return (
    <main className="bg-[#0a0a0a] text-white overflow-x-hidden">
        ...
        <div className="relative max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative">
              {/* Main card */}
              <div className="relative rounded-2xl overflow-hidden border border-white/8 shadow-[0_24px_80px_rgba(0,0,0,0.6)]" style={{ color: "#3b82f6" }}>
                <img
              ...
              >
                <p className="text-2xl font-bold text-white" style={{ color: "#84cc16" }}>40+</p>
            ...
            {projects
              ...
              .map((project) => (
                <motion.div
                  ...
                  className="group flex gap-5 rounded-2xl border border-white/8 bg-[#111] p-5 shadow-[0_4px_16px_rgba(0,0,0,0.3)] transition-shadow duration-300 hover:shadow-[0_8px_32px_rgba(0,0,0,0.5)]"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-1">
                      ...
                      <span className="text-xs text-white/30 whitespace-nowrap">{project.stat}</span>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1 text-xs text-white/40 hover:text-white transition-colors duration-200"
                      >
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1 text-xs text-purple-400 hover:text-purple-300 transition-colors duration-200"
                      >
      ...
      {/* ── TESTIMONIALS ───────────────────────────────────────── */}
      <section id="testimonials" className="py-28 md:py-36 px-6 md:px-10 bg-[#0d0d0d]">
        <div className="max-w-7xl mx-auto">
          <motion.div
            variants={staggerContainer}
            {...motionProps(staggerContainer)}
            ...
            {formSent ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl pl-10 pr-4 py-3 text-sm text-white placeholder:text-white/25 focus:outline-none focus:border-purple-500/50 focus:bg-white/8 transition-all duration-200"
                      />
                    </div>
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <FileText size={15} className="absolute left-3.5 top-3.5 text-white/25" />
                    <textarea
                      id="message"
                      name="message"
                      required
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-xl pl-10 pr-4 py-3 text-sm text-white placeholder:text-white/25 focus:outline-none focus:border-purple-500/50 focus:bg-white/8 transition-all duration-200 resize-none"
                    />
                  </div>
                </div>
                <button
          ...
          <div className="flex items-center gap-4">
            {socialLinks.map((s) => (
              <a
                ...
                rel="noopener noreferrer"
                aria-label={s.label}
                className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center text-white/30 hover:text-purple-400 hover:border-purple-500/40 transition-all duration-300"
              >
                {socialIconMap[s.icon]}
              </a>
            ))}
